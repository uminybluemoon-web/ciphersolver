...
# 春夏秋冬
SEASONS_JP: list[str] = ["はる", "なつ", "あき", "ふゆ"]
...
PREFECTURES_JIS: list[str] = [
    ...
    "にいがた", "とやま", "いしかわ", "ふくい", "やまなし", "ながの",
    "ぎふ", "しずおか", "あいち", "みえ",
    "しが", "きょうと", "おおさか", "ひょうご", "なら", "わかやま",
    "とっとり", "しまね", "おかやま", "ひろしま", "やまぐち",
    "とくしま", "かがわ", "えひめ", "こうち",
    "ふくおか", "さが", "ながさき", "くまもと", "おおいた", "みやざき", "かごしま", "おきなわ",
]

# 都道府県（面積大きい順・国土地理院 令和7年7月1日）読み
PREFECTURES_AREA: list[str] = [
    "ほっかいどう", "いわて", "ふくしま", "ながの", "にいがた", "あきた", "ぎふ",
    "あおもり", "やまがた", "かごしま", "ひろしま", "ひょうご", "しずおか", "みやざき", "くまもと",
    "みやぎ", "おかやま", "こうち", "しまね", "とちぎ", "ぐんま", "おおいた", "やまぐち", "いばらき",
    "みえ", "えひめ", "あいち", "ちば", "ふくおか", "わかやま", "きょうと", "やまなし",
    "とやま", "いしかわ", "ふくい", "とくしま", "ながさき", "しが", "さいたま", "なら",
    "とっとり", "さが", "かながわ", "おきなわ", "とうきょう", "おおさか", "かがわ",
]
